...
def get_args_parser():
    ...
    # Model parameters
    #
    parser.add_argument('--model', default='deit_small_patch16_shrink_base', type=str, metavar='MODEL',
    ...
    #                    help='dataset path')
    parser.add_argument('--data-path', default='E:/workspace/data/ImageNet', type=str,
                       help='dataset path')
    ...
    parser.add_argument('--resume', default='evit-0.7-img224-deit-s.pth', help='resume from checkpoint')
