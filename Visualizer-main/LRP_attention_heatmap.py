...
# Data loading code
traindir = os.path.join('D:\dataset\imagenet', 'train')
valdir = os.path.join('D:\dataset\imagenet', 'val')
...
for l in range(12):
    ...
    np.save("E:\workspace\VLM-pruning\evit-master\Visualizer-main\layer192_{}.npy".format(l), attention_map[l])
